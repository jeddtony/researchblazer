        ...
        <div class="col-12 col-md-7 py offset-md-1">
            ...
            <div class="row">
                <div class=" col-12 col-md-12">
                    <h4 class="center-text">Download {{$chapter->title}} of {{$chapter->project->title}}</h4>
                    <hr>
                    <h5>You are about to pay for this project. Please pay N700 to this account and fill this form.
                    ...
                    <br>
                    <br>
                    <form action="/projects/payment/chapter/{{$chapter->id}}" method="post">
                        @csrf
            ...
            <div class="row">
                <div class="col-12 col-md-12">
                    <h5 class="center-text">Download Other chapters</h5>
                </div>
                ...
                {{--{{dd($chapter->project->chapters)}}--}}
            @foreach($chapter->project->chapters as $chapter)
                <div class="row">
